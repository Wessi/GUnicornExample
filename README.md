...
**The Workflow of Nginx and Gunicorn web servers**
...
3.	If it's a request for data (like a login), Nginx forwards it to Gunicorn (pass data through the WSGI plug).
4.	Gunicorn runs your Python code (Django/Flask/FastAPI/Bottle) via WSGI protocol, gets the result, and hands it back to Nginx.
